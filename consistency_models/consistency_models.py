...
def model_forward_wrapper(
    ...
    **kwargs : Any
    ...
    c_in  = in_scaling(sigma, sigma_data, sigma_min)
    ...
    return c_skip * x + c_out * model(c_in * x, rescaled_t(sigma), **kwargs)
